...
Door bovenstaande casus biedt dit de mogelijkheid om onderzoek te doen naar Microsoft Graph. Om via dit onderzoek het probleem van Easi op te lossen, wordt er zowel een vergelijkende studie als Proof-of-Concept uitgevoerd. De vergelijkende studie vergelijkt de uitfaserende Azure \Ac{AD} Graph met de vervangende Microsoft Graph. De Proof-of-Concept bevat een praktische omzetten van het PowerShell-script van de Azure \Ac{AD} PowerShell naar Microsoft Graph PowerShell. \\
...
Uit de reeds besproken casus wordt volgende hoofdonderzoeksvraag gesteld: “Is Microsoft Graph op dit moment klaar om de beheertaken die mogelijk waren met Azure AD graph over te nemen?” \\

Op bovenstaande hoofdonderzoeksvraag zal dit onderzoek een antwoord geven in de conclusie dat te vinden is in Hoofdstuk \ref{ch:conclusie}.
