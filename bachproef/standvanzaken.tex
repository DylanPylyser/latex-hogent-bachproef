...
Een ander woord voor gedelegeerde machtigingen zijn scopes. Deze scopes maken gebruik van OAuth2-permissies. Microsoft Graph biedt voor bepaalde onderdelen permission scopes aan die de rechten van een gebruiker of applicatie bepalen. In Tabel \ref{psmsg} wordt een overzicht gegeven van alle permissie scope onderdelen of resources die Microsoft Graph aanbiedt, met uitzondering van de preview of niet-stabiele permissies.
...
\begin{table}[ht]
    ...
    \begin{adjustbox}{width=1\textwidth}
        \begin{tabular}{ |c|c| }
            \hline
            \textbf{Permission resource scope} & \textbf{Type} \\
            \hline
            Access review & Application, Delegated \\
            Administrative unit & Application, Delegated \\
            Analytics & Delegated \\
            AppCatalog & Application, Delegated \\
            Application & Application, Delegated \\
            Audit log  & Application, Delegated \\
            BitLocker recovery key & Delegated \\
            Bookings & Application, Delegated \\
            \hline
        \end{tabular}
    \end{adjustbox}
    \caption[Tabel Microsoft Graph Permission scopes]{Tabel met de beschikbare stabiele permissie scopes en scope-type door \textcite{Microsoft2023p}.}
    \label{psmsg}
\end{table}
