...
Zoals reeds vermeld, regelen access tokens de toegang tot het gebruik van Microsoft Graph. Om aan een access token te geraken worden volgende stappen gehanteerd. \\

% TODO: verder schrijven!

Als eerste stap moet de applicatie worden geregisteerd bij Azure \ac{AD}. \\

Als tweede volgt het autoriseren. \\

Daarna moet er een token worden verkregen. \\

Vervolgens wordt de verkregen token gebruikt om Microsoft Graph op te roepen. \\

Als laatste volgt het gebruik van een refresh token.
