...
\begin{figure}[h]
    \scriptsize\begin{verbatim}
GET https://graph.microsoft.com/v1.0/me/calendar/calendarView?startDateTime=
2017-01-01T19:00:00-08:00&endDateTime=2017-01-07T19:00:00-08:00
    \end{verbatim}    
    \caption[Voorbeeld niet-OData HTTP-verzoek]{Praktisch niet-OData voorbeeld van een Microsoft Graph \Ac{API}-eindpunt, waarbij een bepaalde tijdsperiode van de kalender wordt opgevraagd door \textcite{Microsoft2022e}.}
    \label{NRAM}
\end{figure}
