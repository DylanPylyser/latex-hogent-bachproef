...
Drie voorkomende verzoekheaders zijn de volgende:
...
Daarnaast bestaan er ook een aantal antwoordheaders:

\begin{itemize}
    \item Content-Type:
    \item Location:
    \item ocp-aad-diagnostics-server-name:
    \item ocp-aad-session-key:
\end{itemize}
...
\subsection{Waarom Microsoft Graph?} 
