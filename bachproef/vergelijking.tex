...
In dit onderdeel worden er vier HTTP-verzoeken gedaan op basis van de verschillende HTTP-verzoeken die in beide technologieën aanwezig zijn. De verzoeken die worden gebruikt zijn GET, POST, PATCH en DELETE. PUT wordt niet ondersteund in de Azure \ac{AD} Graph Explorer, deze wordt dus niet in de vergelijking opgenomen. \\

Het verzoek of request, en het antwoord of response worden op beide Graph Explorers uitgevoerd en vergeleken. De data uit de vergelijking wordt voorzien door de testomgeving van de Proof-of-Concept. De uitleg over de testomgeving met bijhorende data is te vinden in het volgende hoofdstuk. \\

\subsubsection{Verzoek 1: informatie opvragen over het domein}

Voor Azure \ac{AD} Graph worden volgende eigenschappen meegegeven.

\begin{itemize}
    \item Verzoek: GET
    \item URL: https://graph.windows.net/25ky3d.onmicrosoft.com
    \item api-version: 1.6
\end{itemize}
...
% TODO: tabel op juiste pagina zetten
