...
Naar aanleiding van de snel evoluerende cloudtechnologie, focust Microsoft zich steeds meer op het bouwen van een ecosysteem dat bestuurd kan worden vanuit zoveel mogelijk platformen \autocite{EU2021}.

Deze gedachtegang van Microsoft brengt volgende wijziging met zich mee, namelijk het uitfaseren van de bestaande Azure AD (Active Directory) PowerShell module \autocite{Sahay2022}. Deze wijziging staat gepland om in midden 2023 op Microsoft 365 tenants doorgevoerd te worden.

Bij het IT-bedrijf Easi worden er veel courante taken, automatisaties en wederkerende acties uitgevoerd bij klanten met behulp van de vooraf vernoemde AzureAD-PowerShell module. Hierdoor is het bedrijf genoodzaakt om een oplossing te vinden voor deze uitfaserende module.
...
Dit onderzoek zal zich focussen op wat er vandaag de dag mogelijk is binnen Microsoft Graph. Het doel is om een antwoord te geven op de vraag of de huidige versie van Microsoft Graph klaar is om gebruikt te worden als vervanger van de huidige AzureAD-PowerShell module. Het antwoord op de vraag wordt onderbouwd door een bijhorende Proof-of-Concept die de mogelijkheden van de technologie illustreert.
